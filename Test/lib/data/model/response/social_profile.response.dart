...
//
//     final SocialProfileResModel = SocialProfileResModelFromJson(jsonString);
...
String SocialProfileResModelToJson(SocialProfileResModel data) => json.encode(data.toJson());
...
class SocialProfileResModel {
  ...
  factory SocialProfileResModel.fromJson(Map<String, dynamic> json) => SocialProfileResModel(
        id: json["id"],
        userId: json["user_id"],
        name: json["name"],
        email: json["email"],
